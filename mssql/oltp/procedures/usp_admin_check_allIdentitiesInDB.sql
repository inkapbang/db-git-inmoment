...
GO
-----------
create procedure dbo.usp_admin_check_allIdentitiesInDB
as
...
begin
select @tablename--,@colname,@currentid

set @sql='dbcc checkident ('''+@tablename+''',noreseed)'
--select @sql
...
--exec dbo.usp_admin_check_allIdentitiesInDB
GO
