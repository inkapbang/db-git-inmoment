...
SET ANSI_NULLS ON 
GO
CREATE Procedure [dbo].[sp_SurveyResponse_BeginDate_DateOfService_BeginDateUTC_Modification_test]
...
IF		@deliveryEmailCheck		= 0
	...
	BEGIN
		...
		PRINT ''
		PRINT CHAR(9) + 'sp_SurveyResponse_BeginDate_DateOfService_BeginDateUTC_Modification_AutoDelivery'
...
sp_SurveyResponse_BeginDate_DateOfService_BeginDateUTC_Modification_AutoDelivery
...
--SELECT TOP 50 *	FROM ##Manual_SurveyResponse_BeginDate_DateOfService_BeginDateUTC_Upload
...
select * from ##Manual_SurveyResponse_BeginDate_DateOfService_BeginDateUTC_Update  --Isa	
...
BEGIN 
	...
	from ##Manual_SurveyResponse_BeginDate_DateOfService_BeginDateUTC_Update  --Isa				
...
PRINT CHAR(9) +  'sp_SurveyResponse_BeginDate_DateOfService_BeginDateUTC_Modification_AutoDelivery	@answer = ''EXECUTE'''
PRINT ''
PRINT ''
PRINT '*****  To terminate process  *****'
PRINT  CHAR(9) + 'sp_SurveyResponse_BeginDate_DateOfService_BeginDateUTC_Modification_AutoDelivery	@answer = ''terminate'''
