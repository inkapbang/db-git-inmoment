...
SET ANSI_NULLS ON 
GO
CREATE Proc [dbo].[usp_cust_ClubCorpLastlogin_master] as
...
SET @alertMessage =
		...
		@profile_name = 'Alert', 
		@recipients = 'bluther@mshare.net;trees@mshare.net',
		@subject = 'Clubcorp Last Login',
		@body = 'The attached file contains the activity for Clubcorp Last Login ',
