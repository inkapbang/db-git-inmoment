...
-- =============================================
CREATE PROCEDURE [dbo].[Import_EmpathicaData_Response_Ver5_TIAPEI]
@OrganizationId int,
@ClientId int,
@ResponseId int,
...
/*
	...
	select	r.MS_SurveyGatewayId,
			...
			1,
			--Survey ID:	AccomodationsImport 9169 
			--Offer ID: AccomodationsImport	5509 
			--Gateway:	AccomodationsImport 5455 

			--Survey ID:	CruiseImport 9170 
			--Offer ID: CruiseImport	5510 
			--Gateway: CruiseImport 5454 

			--Survey ID:	CampImport 9172 
			--Offer ID: CampImport 5511 
			--Gateway: CampImport 5457 
			case
				when r.MS_OfferId = 5509 and r.MS_SurveyGatewayID = 5455 then 9169
				when r.MS_OfferId = 5510 and r.MS_SurveyGatewayID = 5454 then 9170
				when r.MS_OfferId = 5511 and r.MS_SurveyGatewayID = 5457 then 9172
				else 9169
			end as MS_SurveyId, 
			1,
			1,
