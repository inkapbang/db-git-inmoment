...
-- =============================================
CREATE PROCEDURE [dbo].[Import_EmpathicaData_Response_Ver5_RAMMP]
@OrganizationId int,
@ClientId int,
@ResponseId int,
...
/*
	...
	select	r.MS_SurveyGatewayId,
			...
			1,
			--sot.MS_SurveyId,
			--Survey ID: Pantry Data Import 9332 
			--Offer ID: Pantry Data Import	5598	
			--Gateway:	Pantry Data Import	5558 

			--Survey ID: Rockwell Data Import 9333 
			--Offer ID: Rockwell Data Import	5599	
			--Gateway:	Rockwell Data Import	5559 
			
			--Survey ID:	Mr. Mike's Data Import	9131 
			--Offer ID: Mr. Mike's Data Import	5495 
			--Gateway:	Mr. Mikes Data Import	5436 
			case
				when r.MS_OfferId = 5598 and r.MS_SurveyGatewayID = 5558 then 9332
				when r.MS_OfferId = 5599 and r.MS_SurveyGatewayID = 5559 then 9333
				when r.MS_OfferId = 5495 and r.MS_SurveyGatewayID = 5436 then 9131
				else 9131
			end as MS_SurveyId, 
			1,
			1,
