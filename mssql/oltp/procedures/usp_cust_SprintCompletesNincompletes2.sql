...
SET ANSI_NULLS ON 
GO
CREATE procedure [dbo].[usp_cust_SprintCompletesNincompletes2]
...
and sr.complete=1
and sr.begindate>@begindt
and sr.begindate < @enddt
...
--exec dbo.usp_cust_SprintCompletesNincompletes2 '1/1/2008','2/1/2008'
GO
