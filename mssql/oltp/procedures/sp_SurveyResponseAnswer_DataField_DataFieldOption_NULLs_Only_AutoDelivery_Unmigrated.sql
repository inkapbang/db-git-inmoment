...
SET ANSI_NULLS ON 
GO
CREATE PROCEDURE [dbo].[sp_SurveyResponseAnswer_DataField_DataFieldOption_NULLs_Only_AutoDelivery_Unmigrated]
...
/****************  BackFill Options Auto Deliver  ****************
	...
	sp_SurveyResponseAnswer_DataField_DataFieldOption_NULLs_Only_AutoDelivery_Unmigrated		
...
IF		@deliveryEmailCheck		= 0
	...
	BEGIN
		...
		PRINT ''
		PRINT CHAR(9) + 'sp_SurveyResponseAnswer_DataField_DataFieldOption_NULLs_Only_AutoDelivery_Unmigrated'
...
IF 
	EXISTS (
		SELECT 1 
		FROM 
			_surveyResponseAnswer_DataField_DataFieldOption_NULLs_Only x
...
BEGIN
	...
	DROP TABLE _surveyResponseAnswer_DataField_DataFieldOption_NULLs_Only
	RETURN
END
...
PRINT CHAR(9) +  'sp_SurveyResponseAnswer_DataField_DataFieldOption_NULLs_Only_AutoDelivery_Unmigrated	@answer = ''EXECUTE'''
PRINT ''
PRINT ''
PRINT '*****  To terminate process  *****'
PRINT  CHAR(9) + 'sp_SurveyResponseAnswer_DataField_DataFieldOption_NULLs_Only_AutoDelivery_Unmigrated	@answer = ''terminate'''
