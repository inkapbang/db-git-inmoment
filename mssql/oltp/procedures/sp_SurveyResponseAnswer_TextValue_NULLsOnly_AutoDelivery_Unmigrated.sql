...
SET ANSI_NULLS ON 
GO
CREATE Procedure [dbo].[sp_SurveyResponseAnswer_TextValue_NULLsOnly_AutoDelivery_Unmigrated]
...
/************** Survey Response Answer Modify TextValue  **************
	...
	sp_SurveyResponseAnswer_TextValue_NULLsOnly_AutoDelivery_Unmigrated	
		@deliveryEmail	= ''''
		, @FileName		= ''''
...
IF		@deliveryEmailCheck		= 0	
	...
	BEGIN
		...
		PRINT 'Survey Response Answer DataField TextValue to NULL Update'
		PRINT CHAR(9) + 'Description:  Updates the TextValue in SurveyResponseAnswer to NULL based on a specified DataFieldId, from a provided file.'
		...
		PRINT ''
		PRINT CHAR(9) + 'sp_SurveyResponseAnswer_TextValue_NULLsOnly_AutoDelivery_Unmigrated'
...
, @subject			= 'Survey Response Answer TextValue to Nulls Only Update Form & Explanation'
, @body_format		= 'Text'
, @body				=
'
...
-----------------
	...
	1. The script only allows for setting a TextValue to NULL given a dataFieldId
	...
	5. Please make sure your file is attached to return email.
...
IF EXISTS(SELECT 1 FROM sys.objects WHERE OBJECT_ID = OBJECT_ID(N'_SurveyResponseAnswer_TextValue_NULLsOnly') AND type = (N'U'))    DROP TABLE _SurveyResponseAnswer_TextValue_NULLsOnly
CREATE TABLE _SurveyResponseAnswer_TextValue_NULLsOnly
		(
...
SET		@FileNameBulkInsertStatement	= 'BULK INSERT _SurveyResponseAnswer_TextValue_NULLsOnly   	FROM ''c:\tmpUpload\' + @FileName + '''	  WITH ( FIRSTROW = 2, FIELDTERMINATOR = '','' )'
...
IF 
	EXISTS (
		SELECT 1 
		FROM 
			_SurveyResponseAnswer_TextValue_NULLsOnly x
...
BEGIN
	...
	DROP TABLE _SurveyResponseAnswer_TextValue_NULLsOnly
	RETURN
END
...
SET 	@originalFileSize	= ( SELECT COUNT(1)		FROM _SurveyResponseAnswer_TextValue_NULLsOnly	)
			

--SELECT @originalFileSize

DECLARE @nullCount			int
SET		@nullCount			= ( SELECT COUNT(1) 	FROM _SurveyResponseAnswer_TextValue_NULLsOnly	WHERE SurveyResponseId IS NULL	OR	DataFieldId IS NULL )
...
IF @nullCount > 0
BEGIN
	DELETE FROM _SurveyResponseAnswer_TextValue_NULLsOnly
	WHERE
...
SET		@notLegitDataField	= 
										(
											SELECT
													COUNT(1)
											FROM
													_SurveyResponseAnswer_TextValue_NULLsOnly	t01
												LEFT JOIN
													DataField										t02
...
BEGIN
	IF EXISTS(SELECT 1 FROM sys.objects WHERE OBJECT_ID = OBJECT_ID(N'_SurveyResponseAnswer_TextValue_NULLsOnly_BadDataField') AND type = (N'U'))    DROP TABLE _SurveyResponseAnswer_TextValue_NULLsOnly_BadDataField
	SELECT
			SurveyResponseId
			, DataFieldId

	INTO _SurveyResponseAnswer_TextValue_NULLsOnly_BadDataField
	FROM
			_SurveyResponseAnswer_TextValue_NULLsOnly	t01
		LEFT JOIN
			DataField										t02
...
--SELECT @originalFileSize, REPLACE(CONVERT(varchar(20), (CAST(COUNT(1) AS money)), 1), '.00', '')	FROM	_SurveyResponseAnswer_TextValue_NULLsOnly
...
BEGIN
	IF EXISTS(SELECT 1 FROM sys.objects WHERE OBJECT_ID = OBJECT_ID(N'_SurveyResponseAnswer_TextValue_NULLsOnly_BadSurveyResponseId') AND type = (N'U'))    DROP TABLE _SurveyResponseAnswer_TextValue_NULLsOnly_BadSurveyResponseId
	SELECT
			SurveyResponseId
			, DataFieldId

	INTO _SurveyResponseAnswer_TextValue_NULLsOnly_BadSurveyResponseId
	FROM
			_SurveyResponseAnswer_TextValue_NULLsOnly	t01
		LEFT JOIN
			SurveyResponse									t02		WITH (NOLOCK)
	...
	FROM
			_SurveyResponseAnswer_TextValue_NULLsOnly							t01
		JOIN
			_SurveyResponseAnswer_TextValue_NULLsOnly_BadSurveyResponseId		t02
...
IF @duplicateCheck	> 0
BEGIN
	IF EXISTS(SELECT 1 FROM sys.objects WHERE OBJECT_ID = OBJECT_ID(N'_SurveyResponseAnswer_TextValue_NULLsOnly_Duplicates') AND type = (N'U'))    DROP TABLE _SurveyResponseAnswer_TextValue_NULLsOnly_Duplicates
	SELECT
			SurveyResponseId
			, DataFieldId
			
	INTO _SurveyResponseAnswer_TextValue_NULLsOnly_Duplicates		
	FROM
			_SurveyResponseAnswer_TextValue_NULLsOnly				t01
	...
	FROM
			_SurveyResponseAnswer_TextValue_NULLsOnly				t01
		JOIN
			_SurveyResponseAnswer_TextValue_NULLsOnly_Duplicates	t02
						ON	
	...
	INSERT INTO _SurveyResponseAnswer_TextValue_NULLsOnly ( SurveyResponseId, DataFieldId )
	SELECT
			SurveyResponseId
			, DataFieldId
			
	FROM
			_SurveyResponseAnswer_TextValue_NULLsOnly_Duplicates			


END


--SELECT * FROM _SurveyResponseAnswer_TextValue_NULLsOnly_Duplicates
...
BEGIN
	IF EXISTS(SELECT 1 FROM sys.objects WHERE OBJECT_ID = OBJECT_ID(N'_SurveyResponseAnswer_TextValue_NULLsOnly_Exist') AND type = (N'U'))    DROP TABLE _SurveyResponseAnswer_TextValue_NULLsOnly_Exist
	SELECT
			SurveyResponseId
			, DataFieldId
			, t02.TextValue
	...
	INTO _SurveyResponseAnswer_TextValue_NULLsOnly_Exist
	FROM
			_SurveyResponseAnswer_TextValue_NULLsOnly				t01
		JOIN
			SurveyResponseAnswer										t02 WITH (NOLOCK)
	...
	FROM
			_SurveyResponseAnswer_TextValue_NULLsOnly				t01
		JOIN
			_SurveyResponseAnswer_TextValue_NULLsOnly_Exist			t02
					ON	
							t01.SurveyResponseId	= t02.SurveyResponseId
						AND
							t01.DataFieldId			= t02.DataFieldId
...
BEGIN
	IF EXISTS(SELECT 1 FROM sys.objects WHERE OBJECT_ID = OBJECT_ID(N'_SurveyResponseAnswer_TextValue_NULLsOnly_Update') AND type = (N'U'))    DROP TABLE _SurveyResponseAnswer_TextValue_NULLsOnly_Update
	SELECT
			SurveyResponseId
			, DataFieldId
			, t02.objectId			AS SurveyResponseAnswerId
	...
	INTO _SurveyResponseAnswer_TextValue_NULLsOnly_Update
	FROM
			_SurveyResponseAnswer_TextValue_NULLsOnly		t01
		JOIN
			SurveyResponseAnswer								t02 WITH (NOLOCK)
	...
	FROM
			_SurveyResponseAnswer_TextValue_NULLsOnly				t01
		JOIN
			_SurveyResponseAnswer_TextValue_NULLsOnly_Update			t02
					ON	
							t01.SurveyResponseId	= t02.SurveyResponseId
						AND
							t01.DataFieldId			= t02.DataFieldId
...
BEGIN
	IF EXISTS(SELECT 1 FROM sys.objects WHERE OBJECT_ID = OBJECT_ID(N'_SurveyResponseAnswer_TextValue_NULLsOnly_Insert') AND type = (N'U'))    DROP TABLE _SurveyResponseAnswer_TextValue_NULLsOnly_Insert
	SELECT
			SurveyResponseId
			, DataFieldId
			, t01.TextValue
	...
	INTO _SurveyResponseAnswer_TextValue_NULLsOnly_Insert
	FROM
			_SurveyResponseAnswer_TextValue_NULLsOnly		t01
		LEFT JOIN
			SurveyResponseAnswer								t02 WITH (NOLOCK)
	...
	FROM
			_SurveyResponseAnswer_TextValue_NULLsOnly				t01
		JOIN
			_SurveyResponseAnswer_TextValue_NULLsOnly_Insert			t02
					ON	
							t01.SurveyResponseId	= t02.SurveyResponseId
						AND
							t01.DataFieldId			= t02.DataFieldId
...
SET		@surveyResponseDataFieldTextValueUnidentified		= ( SELECT COUNT(1)	FROM _SurveyResponseAnswer_TextValue_NULLsOnly )


IF @surveyResponseDataFieldTextValueUnidentified > 0
BEGIN
	IF EXISTS(SELECT 1 FROM sys.objects WHERE OBJECT_ID = OBJECT_ID(N'_SurveyResponseAnswer_TextValue_NULLsOnly_Unidentified') AND type = (N'U'))    DROP TABLE _SurveyResponseAnswer_TextValue_NULLsOnly_Unidentified
	SELECT
			*
	INTO _SurveyResponseAnswer_TextValue_NULLsOnly_Unidentified
	FROM
		_SurveyResponseAnswer_TextValue_NULLsOnly
...
IF EXISTS(SELECT 1 FROM sys.objects WHERE OBJECT_ID = OBJECT_ID(N'_SurveyResponseAnswer_TextValue_NULLsOnly_Statistics') AND type = (N'U'))    DROP TABLE _SurveyResponseAnswer_TextValue_NULLsOnly_Statistics
CREATE TABLE _SurveyResponseAnswer_TextValue_NULLsOnly_Statistics
	(
...
INSERT INTO _SurveyResponseAnswer_TextValue_NULLsOnly_Statistics ( DeliveryEmail, inputFileName, serverName, originalCount, nullCount, notLegitDataField, notLegitSurveyResponseId, duplicateCheck, surveyResponseDataFieldTextValueExist, surveyResponseDataFieldTextValueUpdate, surveyResponseDataFieldTextValueUnidentified, throttle )	
SELECT @deliveryEmail, @FileName, @@SERVERNAME, @originalFileSize, @nullCount, @notLegitDataField, @notLegitSurveyResponseId, @duplicateCheck, @surveyResponseDataFieldTextValueExist , @surveyResponseDataFieldTextValueUpdate, @surveyResponseDataFieldTextValueUnidentified, @throttleCheck
...
PRINT CHAR(9) +  'sp_SurveyResponseAnswer_TextValue_NULLsOnly_AutoDelivery_Unmigrated @answer = ''EXECUTE'''
PRINT ''
PRINT ''
PRINT '*****  To terminate process  *****'
PRINT  CHAR(9) + 'sp_SurveyResponseAnswer_TextValue_NULLsOnly_AutoDelivery_Unmigrated @answer = ''terminate'''
...
SET 	@ThrottleCheck 	= 	( SELECT TOP 1 throttle	FROM _SurveyResponseAnswer_TextValue_NULLsOnly_Statistics )
SET		@check	=	( 
						SELECT 
...
BEGIN
	...
	SET		@sraUpdateCheck		= ( SELECT surveyResponseDataFieldTextValueUpdate			FROM _SurveyResponseAnswer_TextValue_NULLsOnly_Statistics )

--	DECLARE @sraInsertCheck		int
--	SET		@sraInsertCheck		= ( SELECT surveyResponseDataFieldTextValueInsert		FROM _SurveyResponseAnswer_TextValue_NULLsOnly_Statistics )

	
	
	UPDATE _SurveyResponseAnswer_TextValue_NULLsOnly_Statistics
	...
	BEGIN
		...
		SELECT SurveyResponseAnswerId		FROM _SurveyResponseAnswer_TextValue_NULLsOnly_Update
		...
		SET		@successfulUpdates		= ( SELECT COUNT(1)		FROM _SurveyResponseAnswer_TextValue_NULLsOnly_Update	t01		JOIN SurveyResponseAnswer t02	ON t01.surveyResponseAnswerId = t02.objectId AND t01.dataFieldId = t02.DataFieldObjectId AND t02.TextValue IS NULL )
...
/******************************************  Do not need below insert portion **************************************
	...
	BEGIN
		...
		DECLARE mycursor CURSOR for
		SELECT SurveyResponseId, DataFieldId, TextValue FROM _SurveyResponseAnswer_TextValue_NULLsOnly_Insert
		...
		IF EXISTS(SELECT 1 FROM sys.objects WHERE OBJECT_ID = OBJECT_ID(N'_SurveyResponseAnswer_TextValue_NULLsOnly_InsertCompleted') AND type = (N'U'))    DROP TABLE _SurveyResponseAnswer_TextValue_NULLsOnly_InsertCompleted
		SELECT
				SurveyResponseId
				, DataFieldId
				, t01.TextValue
				, t02.objectId			AS SurveyResponseAnswerId
		INTO _SurveyResponseAnswer_TextValue_NULLsOnly_InsertCompleted
		FROM 
				_SurveyResponseAnswer_TextValue_NULLsOnly_Insert				t01		
			JOIN 
				SurveyResponseAnswer											t02	WITH (NOLOCK)
						ON 
							t01.surveyResponseId	= t02.SurveyResponseObjectId 
		...
		FROM
				_SurveyResponseAnswer_TextValue_NULLsOnly_Insert					t01
			JOIN
				_SurveyResponseAnswer_TextValue_NULLsOnly_InsertCompleted		t02
						ON	
								t01.SurveyResponseId	= t02.SurveyResponseId
							AND
								t01.DataFieldId			= t02.DataFieldId
		...
		SET		@successfulInsert		= ( SELECT COUNT(1)		FROM _SurveyResponseAnswer_TextValue_NULLsOnly_InsertCompleted )
...
SET @deliveryEmailV2										= ( SELECT deliveryEmail											FROM _SurveyResponseAnswer_TextValue_NULLsOnly_Statistics )
SET @inputFileNameV2										= ( SELECT inputFileName											FROM _SurveyResponseAnswer_TextValue_NULLsOnly_Statistics )
SET @serverNameV2											= ( SELECT serverName												FROM _SurveyResponseAnswer_TextValue_NULLsOnly_Statistics )
SET @originalCountV2										= ( SELECT originalCount											FROM _SurveyResponseAnswer_TextValue_NULLsOnly_Statistics )
SET @nullCountV2											= ( SELECT nullCount												FROM _SurveyResponseAnswer_TextValue_NULLsOnly_Statistics )
SET @notLegitDataFieldV2 									= ( SELECT notLegitDataField										FROM _SurveyResponseAnswer_TextValue_NULLsOnly_Statistics )
SET @notLegitSurveyResponseIdV2								= ( SELECT notLegitSurveyResponseId									FROM _SurveyResponseAnswer_TextValue_NULLsOnly_Statistics )
SET @duplicateCheckV2										= ( SELECT duplicateCheck											FROM _SurveyResponseAnswer_TextValue_NULLsOnly_Statistics )
SET @surveyResponseDataFieldTextValueExistV2				= ( SELECT surveyResponseDataFieldTextValueExist					FROM _SurveyResponseAnswer_TextValue_NULLsOnly_Statistics )
SET @surveyResponseDataFieldTextValueUpdateV2				= ( SELECT surveyResponseDataFieldTextValueUpdate			FROM _SurveyResponseAnswer_TextValue_NULLsOnly_Statistics )
SET @surveyResponseDataFieldTextValueUnidentifiedV2			= ( SELECT surveyResponseDataFieldTextValueUnidentified		FROM _SurveyResponseAnswer_TextValue_NULLsOnly_Statistics )
...
IF @sraInsertCheck > 0
BEGIN
	SET @surveyResponseDataFieldTextValueInsertFailedV2			= ( SELECT COUNT(1)											FROM _SurveyResponseAnswer_TextValue_NULLsOnly_Insert )
END
...
SET @ProcessingStartV2			= ( SELECT ProcessingStart				FROM _SurveyResponseAnswer_TextValue_NULLsOnly_Statistics )
SET @ProcessingCompleteV2		= ( SELECT ProcessingComplete			FROM _SurveyResponseAnswer_TextValue_NULLsOnly_Statistics )
...
BEGIN	
	...
	FROM
			_SurveyResponseAnswer_TextValue_NULLsOnly_Insert
...
BEGIN
	...
	FROM
			_SurveyResponseAnswer_TextValue_NULLsOnly_BadSurveyResponseId
END
...
BEGIN
	...
	FROM
			_SurveyResponseAnswer_TextValue_NULLsOnly_BadDataField
END
...
BEGIN
	...
	FROM
		_SurveyResponseAnswer_TextValue_NULLsOnly_Exist
...
BEGIN
	...
	FROM
			_SurveyResponseAnswer_TextValue_NULLsOnly_Unidentified
...
BEGIN
	INSERT INTO ##SurveyResponseAnswerStatus_Action ( Action, SurveyResponseId, DataFieldId, SurveyResponseAnswerId, TextValue_Old )
	SELECT 	'Updated'
			, SurveyResponseId
			, DataFieldId
			...
			, TextValue_Old
	FROM
			_SurveyResponseAnswer_TextValue_NULLsOnly_Update
...
BEGIN
	...
	SELECT 	'Inserted'
			...
			, SurveyResponseAnswerId
	FROM
			_SurveyResponseAnswer_TextValue_NULLsOnly_InsertCompleted
...
Survey Response Answer TextValue to NULL Backfill
...
, @reply_to						= 'dba@Inmoment.com'
, @subject						= 'Survey Response Answer DataField TextValue to NULL Completed'
, @body_format					= 'HTML'
, @body							= @bodyV2
