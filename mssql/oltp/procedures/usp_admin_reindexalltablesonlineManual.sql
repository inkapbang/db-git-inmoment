...
SET ANSI_NULLS ON 
GO
CREATE proc [dbo].[usp_admin_reindexalltablesonlineManual]
as 
...
if @tableName not in ( --'surveyresponse','surveyresponsescore',
'binarycontent','surveyresponseanswer','emailqueue',
...
' REBUILD WITH ( SORT_IN_TEMPDB = On,ONLINE=ON)'+char(13)+
'end try'+char(13)+
'BEGIN CATCH'+CHAR(13)+
...
--exec usp_admin_reindexalltablesonlineManual
--
