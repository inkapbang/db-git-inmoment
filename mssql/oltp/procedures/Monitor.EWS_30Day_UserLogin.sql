...
/*****************************************************  Login Portion Below  *********************************************************************/
--DROP Procedure Monitor.EWS_30Day_UserLogin
--CREATE Procedure Monitor.EWS_30Day_UserLogin
CREATE Procedure Monitor.EWS_30Day_UserLogin
AS
/*****************************************  EWS Project  *****************************************
...
-- Results Table
IF EXISTS(SELECT 1 FROM sys.objects WHERE OBJECT_ID = OBJECT_ID(N'Monitor.EWS_30Day_UserLogin_Results') AND type = (N'U'))    DROP TABLE Monitor.EWS_30Day_UserLogin_Results
SELECT
...
INTO Monitor.EWS_30Day_UserLogin_Results
