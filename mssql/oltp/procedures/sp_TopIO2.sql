...
SET ANSI_NULLS ON 
GO
CREATE procedure [dbo].[sp_TopIO2]
as
--exec dbo.go

IF  Not EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[_TopIO2]') AND type in (N'U'))
begin
--drop table _who2
CREATE TABLE [dbo].[_TopIO2](
	[SPID] [int] NOT NULL,
