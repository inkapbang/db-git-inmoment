...
-- =============================================
CREATE PROCEDURE [dbo].[Import_EmpathicaData_Response_Ver5_Maggianosmee]
@OrganizationId int,
@ClientId int,
@ResponseId int,
...
/*
	...
	select	r.MS_SurveyGatewayId,
			...
			--sot.MS_SurveyId,
			case
				when r.MS_OfferId = 6007 and r.MS_SurveyGatewayID = 6040 then 10019
				when r.MS_OfferId = 6006 and r.MS_SurveyGatewayID = 6039 then 10018
				else 10018
			end as MS_SurveyId, 
			1,
			1,
