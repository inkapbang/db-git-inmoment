...
SET ANSI_NULLS ON 
GO
CREATE proc [dbo].[GatewayDetailsReport_20190513]
...
set nocount on
  ...
  left join Campaign c on sg.campaignObjectId = c.objectId
  left join SurveyGatewayCampaign sgc on sgc.surveyGatewayObjectId = sg.objectId
  left join Campaign c2 on sgc.campaignObjectId = c2.objectId
