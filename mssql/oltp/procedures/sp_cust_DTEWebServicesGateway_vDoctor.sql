...
SET ANSI_NULLS ON 
GO
CREATE PROCEDURE [dbo].sp_cust_DTEWebServicesGateway_vDoctor
AS
...
/******************************  Hourly Gateway Check  ***************************
	...
	History
		Sep 20, 2016	Bailey Hu
			-- Hourly response volume check for a given gateway: 2848	DTE Web Services
