...
--and name like 'z%'
-------------------------
CREATE procedure [dbo].[usp_cust_AaronsIPQuarantine]
as
...
exec [dbo].[usp_cust_AaronsIPQuarantine]
*/
...
and complete=1
and not (offerCode='9999999999' and offerObjectId=2218 and locationObjectId=370544)--offercodeobjectid != 1073994
--select * from _AaronsIPscrub
update surveyresponse with (rowlock)
set externalid=cast(offerobjectid as varchar(25)),offerCode='9999999999',offerObjectId=2218,locationObjectId=370544--offercodeobjectid=1073994
where objectid in (
