...
SET ANSI_NULLS ON 
GO
CREATE Procedure [dbo].[sp_SurveyResponse_Location_Offer_OfferCode_AutoDelivery]
...
/****************  BackFill Options Auto Deliver  ****************
	...
	sp_SurveyResponse_Location_Offer_OfferCode_AutoDelivery		
...
IF		@deliveryEmailCheck		= 0
	...
	BEGIN
		...
		PRINT ''
		PRINT CHAR(9) + 'sp_SurveyResponse_Location_Offer_OfferCode_AutoDelivery'
...
PRINT CHAR(9) +  'sp_SurveyResponse_Location_Offer_OfferCode_AutoDelivery	@answer = ''EXECUTE'''
PRINT ''
PRINT ''
PRINT '*****  To terminate process  *****'
PRINT  CHAR(9) + 'sp_SurveyResponse_Location_Offer_OfferCode_AutoDelivery	@answer = ''terminate'''
