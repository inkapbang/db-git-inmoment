...
SET ANSI_NULLS ON 
GO
create PROCEDURE [dbo].[sp_Translation_DashboardComponentName] 
...
SET @query = 									
'select * from 
(select d.organizationId [organizationObjectid],lsv.value [componentName]
