...
SET ANSI_NULLS ON 
GO
CREATE PROCEDURE [dbo].[sp_SurveyResponseAnswer_BooleanValue_NULLsOnly_AutoDelivery_Unmigrated]
...
/************** Survey Response Answer Modify BooleanValue  **************
	...
	sp_SurveyResponseAnswer_BooleanValue_NULLsOnly_AutoDelivery_Unmigrated	
		@deliveryEmail	= ''''
		, @FileName		= ''''
...
IF		@deliveryEmailCheck		= 0	
	...
	BEGIN
		...
		PRINT ''
		PRINT CHAR(9) + 'sp_SurveyResponseAnswer_BooleanValue_NULLsOnly_AutoDelivery_Unmigrated'
...
IF 
	EXISTS (
		SELECT 1 
		FROM 
			_surveyResponseAnswer_BooleanValue_NULLsOnly x
...
BEGIN
	...
	DROP TABLE _surveyResponseAnswer_BooleanValue_NULLsOnly
	RETURN
END
...
PRINT CHAR(9) +  'sp_SurveyResponseAnswer_BooleanValue_NULLsOnly_AutoDelivery_Unmigrated @answer = ''EXECUTE'''
PRINT ''
PRINT ''
PRINT '*****  To terminate process  *****'
PRINT  CHAR(9) + 'sp_SurveyResponseAnswer_BooleanValue_NULLsOnly_AutoDelivery_Unmigrated @answer = ''terminate'''
