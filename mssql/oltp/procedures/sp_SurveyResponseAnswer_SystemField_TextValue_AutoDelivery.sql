...
SET ANSI_NULLS ON 
GO
CREATE PROCEDURE [dbo].[sp_SurveyResponseAnswer_SystemField_TextValue_AutoDelivery]
...
/************** Survey Response Answer Modify TextValue  **************
	...
	sp_SurveyResponseAnswer_TextValue_AutoDelivery	
		@deliveryEmail	= ''''
		, @FileName		= ''''
...
IF		@deliveryEmailCheck		= 0	
	...
	BEGIN
		...
		PRINT ''
		PRINT CHAR(9) + 'sp_SurveyResponseAnswer_TextValue_AutoDelivery'
...
--SELECT TOP 25 *		FROM _surveyResponseAnswer_DataField_TextValue
...
-- Verifies DataField is legit  -- only considering system fields.
...
SET		@notLegitDataField	= 
										(
											...
											FROM
												...
												LEFT JOIN
													DataField									t02
															ON t01.DataFieldId = t02.objectId AND t02.systemField = 1 
											WHERE
...
PRINT CHAR(9) +  'sp_SurveyResponseAnswer_SystemField_TextValue_AutoDelivery @answer = ''EXECUTE'''
PRINT ''
PRINT ''
PRINT '*****  To terminate process  *****'
PRINT  CHAR(9) + 'sp_SurveyResponseAnswer_SystemField_TextValue_AutoDelivery @answer = ''terminate'''
