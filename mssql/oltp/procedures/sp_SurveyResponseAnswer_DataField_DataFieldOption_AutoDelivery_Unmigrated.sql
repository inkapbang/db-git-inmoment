...
SET ANSI_NULLS ON 
GO
CREATE PROCEDURE [dbo].[sp_SurveyResponseAnswer_DataField_DataFieldOption_AutoDelivery_Unmigrated]
...
PRINT CHAR(9) +  'sp_SurveyResponseAnswer_DataField_DataFieldOption_AutoDelivery_Unmigrated	@answer = ''EXECUTE'''
PRINT ''
PRINT ''
PRINT '*****  To terminate process  *****'
PRINT  CHAR(9) + 'sp_SurveyResponseAnswer_DataField_DataFieldOption_AutoDelivery_Unmigrated	@answer = ''terminate'''
