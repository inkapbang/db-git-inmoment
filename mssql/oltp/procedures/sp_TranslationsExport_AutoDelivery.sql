...
SET ANSI_NULLS ON 
GO
CREATE PROCEDURE [dbo].[sp_TranslationsExport_AutoDelivery]
	@DisplayInfo				int				= 1
	, @ShowChecks				int				= 0		
...
exec dbo.sp_TranslationsExport_AutoDelivery @OrganizationObjectId=2285,  @DeliveryEmail='bluther@inmoment.com'
	select * from organization where objectid=2285		
************************************************************************************************************************/
SET NOCOUNT ON
...
BEGIN
	...
	PRINT N'	, @DeliveryEmail            = ''bluther@InMoment.com'''
...
@profile_name					= 'Internal Request'
, @recipients					= @DeliveryEmail
, @copy_recipients 				= 'bluther@InMoment.com' --; bluther@InMoment.com'
, @reply_to						= 'dba@InMoment.com'
