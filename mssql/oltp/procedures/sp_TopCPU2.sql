...
SET ANSI_NULLS ON 
GO
CREATE procedure [dbo].[sp_TopCPU2]
as
--exec dbo.go

IF  Not EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[_TopCPU2]') AND type in (N'U'))
begin
--drop table _who2
CREATE TABLE [dbo].[_TopCPU2](
	[SPID] [int] NOT NULL,
...
truncate table _TopCPU2;

insert into _TopCPU2(
SPID,
Status,
login,
HostName,
