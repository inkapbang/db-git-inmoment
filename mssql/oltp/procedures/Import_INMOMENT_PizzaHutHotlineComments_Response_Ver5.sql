...
-- =============================================
CREATE PROCEDURE [dbo].[Import_INMOMENT_PizzaHutHotlineComments_Response_Ver5]
@OrganizationId int,
...
/*
	...
	from	putwh06.Import.dbo.responseheader_inmoment_phhotlinetest r with (nolock)
	...
	UPDATE putwh06.Import.dbo.responseheader_inmoment_phhotlinetest
