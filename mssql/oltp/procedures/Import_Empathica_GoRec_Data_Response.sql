...
-- =============================================
CREATE PROCEDURE [dbo].[Import_Empathica_GoRec_Data_Response]
@OrganizationId int,
@ClientId int,
...
/*
	...
	union all
	select	110832,NULL,convert(varchar(200),@Val_110832),NULL
	union all
	...
	union all
	select	54,NULL,NULL,@Val_54
	union all
	select	110817,NULL,NULL,@Val_110817
	union all
	select	110842,NULL,NULL,@Val_110842
	union all
	select	97933,NULL,NULL,@Val_97933
	union all
	select	110814,convert(varchar(200),@Val_110814),NULL,NULL
	union all
	select	110827,convert(varchar(200),@Val_110827),NULL,NULL
	union all
	select	110834,NULL,convert(varchar(200),@Val_110834),NULL
	union all
	select	97937,NULL,NULL,@Val_97937
	union all
	select	110816,convert(varchar(200),@Val_110816),NULL,NULL
	union all
	select	110829,convert(varchar(200),@Val_110829),NULL,NULL
	union all
	select	110836,NULL,convert(varchar(200),@Val_110836),NULL
	union all
	...
	union all
	select	110812,NULL,NULL,@Val_110812
	union all
	select	110813,convert(varchar(200),@Val_110813),NULL,NULL
	union all
	select	110818,convert(varchar(200),@Val_110818),NULL,NULL
	union all
	select	110826,convert(varchar(200),@Val_110826),NULL,NULL
	union all
	select	110819,NULL,NULL,@Val_110819
	union all
	select	110840,NULL,NULL,NULL
	union all
	select	110823,NULL,NULL,@Val_110823
	union all
	select	110841,NULL,NULL,NULL
	union all
	select	110820,NULL,NULL,@Val_110820
	union all
	select	110821,NULL,NULL,NULL
	union all
	select	110824,NULL,NULL,@Val_110824
	union all
	select	110822,NULL,NULL,@Val_110822
	union all
	select	110825,NULL,NULL,@Val_110825
	union all
	select	110833,NULL,convert(varchar(200),@Val_110833),NULL
	union all
