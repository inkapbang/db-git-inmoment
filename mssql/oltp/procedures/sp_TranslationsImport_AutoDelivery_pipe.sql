...
SET ANSI_NULLS ON 
GO
CREATE PROCEDURE [dbo].[sp_TranslationsImport_AutoDelivery_pipe]
	@DisplayInfo		int 			= 1
	, @ShowChecks		int 			= 0
...
select lsv.localizedStringObjectId, 'nl' as 'LocaleKey', s.nb as 'Value' 
from Tag t
join __z_translation s on t.name = s.en
