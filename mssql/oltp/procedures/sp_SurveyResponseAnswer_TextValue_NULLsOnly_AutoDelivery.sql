...
SET ANSI_NULLS ON 
GO
CREATE Procedure [dbo].[sp_SurveyResponseAnswer_TextValue_NULLsOnly_AutoDelivery]
...
/************** Survey Response Answer Modify TextValue  **************
	...
	sp_SurveyResponseAnswer_TextValue_NULLsOnly_AutoDelivery	
		@deliveryEmail	= ''''
		, @FileName		= ''''
...
IF		@deliveryEmailCheck		= 0	
	...
	BEGIN
		...
		PRINT ''
		PRINT CHAR(9) + 'sp_SurveyResponseAnswer_TextValue_NULLsOnly_AutoDelivery'
...
--SELECT TOP 25 *		FROM _SurveyResponseAnswer_TextValue_NULLsOnly
...
PRINT CHAR(9) +  'sp_SurveyResponseAnswer_TextValue_NULLsOnly_AutoDelivery @answer = ''EXECUTE'''
PRINT ''
PRINT ''
PRINT '*****  To terminate process  *****'
PRINT  CHAR(9) + 'sp_SurveyResponseAnswer_TextValue_NULLsOnly_AutoDelivery @answer = ''terminate'''
