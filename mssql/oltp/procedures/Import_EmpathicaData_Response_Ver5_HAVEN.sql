...
-- =============================================
CREATE PROCEDURE [dbo].[Import_EmpathicaData_Response_Ver5_HAVEN]
@OrganizationId int,
@ClientId int,
@ResponseId int,
...
/*
	...
	select	r.MS_SurveyGatewayId,
			...
			--Path :			Survey/gateway/offer
			--Holiday Maker :	10414 / 6315 / 6229
			--Ownership :		10415 / 6317 / 6230
			--Handover :		10416 / 6318 / 6231 
			
			case
				when r.MS_OfferId = 6229 and r.MS_SurveyGatewayID = 6315 then 10414
				when r.MS_OfferId = 6230 and r.MS_SurveyGatewayID = 6317 then 10415
				when r.MS_OfferId = 6231 and r.MS_SurveyGatewayID = 6318 then 10416
				else 9131
			end as MS_SurveyId, 
			1,
			1,
