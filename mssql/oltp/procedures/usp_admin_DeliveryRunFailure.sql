...
SET ANSI_NULLS ON 
GO
CREATE Proc [dbo].[usp_admin_DeliveryRunFailure]
AS
...
BEGIN
	...
	begin
		SET @alertMessage =
		'Delivery Run Failure Last Night'

		EXEC msdb.dbo.sp_send_dbmail
		@profile_name = 'Alert',
		@recipients = 'alert@mshare.net', 
		--@recipients = 'mshare@mailman.xmission.com',
		@subject = 'Delivery Run failure last night check delivery run',
		@subject = 'Delivery Run failure last night check delivery run',
		@body = @alertMessage,
		@importance = 'High'
...
--exec [dbo].[usp_admin_DeliveryRunFailure]
GO
