...
SET ANSI_NULLS ON 
GO
CREATE PROC [dbo].[usp_app_UpdateLocationCategoryNestedSets_2](@rootId INT, @offset INT)
AS
BEGIN
      SET NOCOUNT ON;
	  ...
	  WHERE	L.rootObjectId != @rootId
			OR L.depth != NS.depth
			OR L.leftExtent != (NS.leftExtent + @offset)
			OR L.rightExtent != (NS.rightExtent + @offset)
