...
SET ANSI_NULLS ON 
GO
CREATE Procedure [dbo].[sp_SurveyResponseAnswer_NumericValue_NULLsOnly_AutoDelivery_Unmigrated]
...
/************** Survey Response Answer Modify NumericValue  **************
	...
	sp_SurveyResponseAnswer_NumericValue_NULLsOnly_AutoDelivery_Unmigrated	
		@deliveryEmail	= ''''
		, @FileName		= ''''
...
IF		@deliveryEmailCheck		= 0	
	...
	BEGIN
		...
		PRINT ''
		PRINT CHAR(9) + 'sp_SurveyResponseAnswer_NumericValue_NULLsOnly_AutoDelivery_Unmigrated'
...
IF 
	EXISTS (
		SELECT 1 
		FROM 
			_SurveyResponseAnswer_NumericValue_NULLsOnly x
...
BEGIN
	...
	DROP TABLE _SurveyResponseAnswer_NumericValue_NULLsOnly
	RETURN
END
...
PRINT CHAR(9) +  'sp_SurveyResponseAnswer_NumericValue_NULLsOnly_AutoDelivery_Unmigrated @answer = ''EXECUTE'''
PRINT ''
PRINT ''
PRINT '*****  To terminate process  *****'
PRINT  CHAR(9) + 'sp_SurveyResponseAnswer_NumericValue_NULLsOnly_AutoDelivery_Unmigrated @answer = ''terminate'''
