...
SET ANSI_NULLS ON 
GO
CREATE PROCEDURE [dbo].[UserAccountAndRoleFullList_SOC_Audit_022519]
...
/*********************  Mindshare User Account And Role Full List  *********************
  ...
  Usage: 
      ...
      exec UserAccountAndRoleFullList_SOC_Audit_022519 @deliveryemail='MChriss@Inmoment.com,@ShowResults=Y'
...
FROM
		oltp.dbo.UserAccount				t10		
	JOIN
		oltp.dbo.UserAccountRole			t20		
			ON t10.objectId	= t20.userAccountObjectId
			
	LEFT JOIN
		oltp.dbo.Organization						t30		
