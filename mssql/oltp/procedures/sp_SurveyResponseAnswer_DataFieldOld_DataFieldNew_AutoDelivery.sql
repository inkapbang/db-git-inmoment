...
SET ANSI_NULLS ON 
GO
CREATE Procedure [dbo].[sp_SurveyResponseAnswer_DataFieldOld_DataFieldNew_AutoDelivery]
...
/****************  BackFill Options Auto Deliver  ****************
	...
	sp_SurveyResponseAnswer_DataFieldOld_DataFieldNew_AutoDelivery		
...
IF		@deliveryEmailCheck		= 0
	...
	BEGIN
		...
		PRINT ''
		PRINT CHAR(9) + 'sp_SurveyResponseAnswer_DataFieldOld_DataFieldNew_AutoDelivery'
...
PRINT CHAR(9) +  'sp_SurveyResponseAnswer_DataFieldOld_DataFieldNew_AutoDelivery	@answer = ''EXECUTE'''
PRINT ''
PRINT ''
PRINT '*****  To terminate process  *****'
PRINT  CHAR(9) + 'sp_SurveyResponseAnswer_DataFieldOld_DataFieldNew_AutoDelivery	@answer = ''terminate'''
