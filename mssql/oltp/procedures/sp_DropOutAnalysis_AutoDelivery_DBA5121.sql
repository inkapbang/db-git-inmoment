...
SET ANSI_NULLS ON 
GO
CREATE Procedure [dbo].[sp_DropOutAnalysis_AutoDelivery_DBA5121]
...
IF		@deliveryEmailCheck	= 1
	...
	BEGIN
		...
		select objectId	AS SurveyResponseObjectId into _DBA5121_dropOutReport from ##dropOutAnalysis_03				---Isa.
