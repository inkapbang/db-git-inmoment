...
SET ANSI_NULLS ON 
GO
--DROP Procedure Monitor.EWS_30Day_SurveyCompletion
--CREATE Procedure Monitor.EWS_30Day_SurveyCompletion
CREATE Procedure Monitor.EWS_30Day_SurveyCompletion
AS
/*****************************************  EWS Project  *****************************************
...
-- Results Table
IF EXISTS(SELECT 1 FROM sys.objects WHERE OBJECT_ID = OBJECT_ID(N'Monitor.EWS_30Day_SurveyCompletion_Results') AND type = (N'U'))    DROP TABLE Monitor.EWS_30Day_SurveyCompletion_Results
SELECT
...
INTO Monitor.EWS_30Day_SurveyCompletion_Results	
