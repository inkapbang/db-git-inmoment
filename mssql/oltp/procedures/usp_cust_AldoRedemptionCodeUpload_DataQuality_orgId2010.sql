...
SET ANSI_NULLS ON 
GO
CREATE Procedure [dbo].[usp_cust_AldoRedemptionCodeUpload_DataQuality_orgId2010]
AS
...
-- select * from _RedemptionCodeCustom_Staging where  OrganizationObjectId <> 2010
update _RedemptionCodeCustom_Staging set error = isnull(error,'') + 'OrgID: Not allowed. ' where  OrganizationObjectId <> 2010
