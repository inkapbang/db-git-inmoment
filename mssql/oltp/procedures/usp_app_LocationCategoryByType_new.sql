...
SET ANSI_NULLS ON 
GO
CREATE procedure [dbo].[usp_app_LocationCategoryByType_new]
	@locationId int,
	@categoryTypeId int,
...
begin
	...
	select @categoryId = (select top 1 locationCategoryObjectId from dbo.ufn_app_LocationAncestorCategories_new (@locationId, @categoryTypeId) order by hierarchyLevel)
