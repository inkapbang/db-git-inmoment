...
SET ANSI_NULLS ON 
GO
CREATE PROCEDURE [dbo].[sp_SurveyResponse_ExclusionReason_AutoDelivery]
...
/****************  Set Exclusion Reason Auto Deliver  ****************
	...
	sp_SurveyResponse_ExclusionReason_AutoDelivery		
...
IF		@deliveryEmailCheck		= 0
	...
	BEGIN
		...
		PRINT ''
		PRINT CHAR(9) + 'sp_SurveyResponse_ExclusionReason_AutoDelivery'
...
PRINT CHAR(9) +  'sp_SurveyResponse_ExclusionReason_AutoDelivery	@answer = ''EXECUTE'''
PRINT ''
PRINT ''
PRINT '*****  To terminate process  *****'
PRINT  CHAR(9) + 'sp_SurveyResponse_ExclusionReason_AutoDelivery	@answer = ''terminate'''
