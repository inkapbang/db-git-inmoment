...
--DROP TABLE [dbo].[_sr];
    ...
    create procedure [dbo].[usp_cust_WalgreensDropOut32]
    as
    --exec dbo.usp_cust_WalgreensDropOut32
...
--Join em 
select objectid srobjectid,ipaddress,surveyname,value,begindate,begintime,location,offername,
...
--select *  
from (
select _sr.objectid,ipaddress,_sr.name as surveyname,begindate,begintime,location,offername,lsv.value--,loyaltyNumber,offerCode
from _sr 
join locationattribute la
on la.objectid=_sr.locationattributeobjectid
