...
SET ANSI_NULLS ON 
GO
CREATE procedure [dbo].[usp_cust_comcast_nocompletecallslastthirtymin]
as
...
set @startdt=dateadd(mi,-40,getutcdate());
--select @startdt;
...
--		
		...
		@body = 'The attached file contains the results from [dbo].[usp_cust_comcast_nocompletecallslastthirtymin].',
