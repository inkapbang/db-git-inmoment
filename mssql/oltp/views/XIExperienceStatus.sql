...
SET ANSI_NULLS ON 
GO
CREATE VIEW [dbo].[XIExperienceStatus] AS

select top 100 percent o1.objectid 'orgid', o1.name 'org', 
...
and o1.name not like 'Ops%'
and o1.name not like 'QA%'
and o1.name not like 'Inmoment%'
and o1.name not like '%jira%'
and o1.name not like 'test%'
and o1.name not like '*%'
