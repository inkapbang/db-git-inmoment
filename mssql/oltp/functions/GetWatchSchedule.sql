...
SET ANSI_NULLS ON 
GO
CREATE FUNCTION [dbo].[GetWatchSchedule] (@beginDate DATETIME, @endDate DATETIME)
...
BEGIN 
	...
	INSERT INTO @watchUsers VALUES (71723, 'tbillings@mshare.net', 0)
	INSERT INTO @watchUsers VALUES (96879, 'btenney@mshare.net', 1)
	INSERT INTO @watchUsers VALUES (362, 'rwalker@mshare.net', 2)
	INSERT INTO @watchUsers VALUES (121411, 'kwayment@mshare.net', 3)
	INSERT INTO @watchUsers VALUES (127, 'kwilliams@mshare.net', 4)
	INSERT INTO @watchUsers VALUES (68194, 'gmcclellan@mshare.net', 5)
	INSERT INTO @watchUsers VALUES (79745, 'cgolightly@mshare.net', 6)
	INSERT INTO @watchUsers VALUES (6014, 'dnewbold@mshare.net', 7)
	INSERT INTO @watchUsers VALUES (58355, 'drobinson@mshare.net', 8)
	INSERT INTO @watchUsers VALUES (70891, 'shart@mshare.net', 9)
